require("./import");
const { timeout, placeItem, findClosestResourcePatch, dragBelt, getHubGoals } = require("./test_helpers");
...
test("level 1", async () => {
    ...
    await placeItem("miner", closest.x, closest.y);
    await dragBelt(closest.x, closest.y - 1, -3, 1);
